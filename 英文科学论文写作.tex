...
To overcome the aformentioned chanllenge, Google has developed a state-of-the-art algorithm called PageRank, which is currently a fundamental algorithm in web search and redefine how we navigate web search and information retrieval.
...
In this paper, we make the following simple insights and research:
\begin{itemize}
